...
var sites = [
    ['Berg Restaurant', 51.104411, 17.01300, 1]
];
    ...
    open: function() {
        ...
        $('.reorder a').on(eventType, function(e) {
            ...
            if ($('body').hasClass('mobile-nav-show')) {
                ...
                $('#flyout-container').velocity({ height: 0 }, {
                    complete: function() {
                ...
                $('#flyout-container').velocity({ height: $('#flyout-container .flyout-menu > li').height() * $('#flyout-container .flyout-menu > li').length }, {
                    complete: function() {
        ...
        $('.flyout-menu .open-children').on(eventType, function(e) {
            ...
            if ($(this).next('.subnav').length > 0) {
                ...
                if ($(this).next('.subnav').hasClass('open')) {
                    ...
                    $(this).next('.subnav').velocity({ height: 0 }, {
                        complete: function() {
                    ...
                    $(this).next('.subnav').velocity({ height: $(this).next('.subnav').children('li').height() * $(this).next('.subnav').children('li').length }, {
                        complete: function() {
...
var blog = {
    ...
    add: function(response) {
        ...
        $('#blog.blog-content .load-more').velocity({ opacity: 0 }, {
            duration: 400,
            complete: function() {
                $(this).remove();
                ...
                $('#blog-content-append .load-post').imagesLoaded(function() {
                    ...
                    $('#blog-content-append').velocity({ height: oldHeight + newHeight }, {
                        complete: function() {
                            $.waypoints('refresh');
